...
class SearchVC: UIViewController {
    ...
    func configureLogoImageView() {
        ...
        NSLayoutConstraint.activate([
            logoImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: topConstarintConstant),
    ...
    func configureTextField() {
        ...
        NSLayoutConstraint.activate([
            ...
            // on trailing or bottom anchors we have to use negative numbers
